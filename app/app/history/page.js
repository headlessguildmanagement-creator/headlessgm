...
export default async function HistoryPage({ searchParams }) {
  ...
  return (
    <AppShell guildName={guild.name} guildSlug={guild.slug} eyebrow="HISTORY" title="Guild History" activeHref="/app/history" actions={guild.plan_code === "free" ? null : <a className="button ghost" href={`/api/export?guild=${encodeURIComponent(guild.slug)}`}>Export guild backup</a>}>
